...
MayankOS పురాణ [ZaneyOS](https://gitlab.com/Zaney/zaneyos.git) ప్రాజెక్ట్ యొక్క గర్వించదగిన వారసుడు. NixOSని అందుబాటులోకి మరియు అందంగా మార్చాలనే అదే స్ఫూర్తిని పంచుకున్నప్పటికీ, MayankOS తనదైన దృష్టితో ఒక ప్రత్యేక పంపిణీగా అభివృద్ధి చెందింది:
...
- **Niri ఇంటిగ్రేషన్**: మేము **Niri స్క్రోలబుల్-టైలింగ్ కంపోజిటర్** కోసం ఫస్ట్-క్లాస్ మద్దతును జోడించాము, ఇది అసలు ZaneyOSలో లేని ప్రత్యేకమైన వర్క్‌ఫ్లో.
- **మెరుగైన అంతర్జాతీయీకరణ**: NixOS అనుభవం ప్రపంచవ్యాప్త ప్రేక్షకులకు అందించడానికి 13+ భాషలకు మద్దతు.

మీరు అసలు స్ఫూర్తి కోసం చూస్తున్నట్లయితే, దయచేసి [అధికారిక ZaneyOS GitLab](https://gitlab.com/Zaney/zaneyos.git)ని సందర్శించండి. MayankOS ఆ అద్భుతమైన పునాదిని తీసుకుంటుంది మరియు అత్యాధునిక హార్డ్‌వేర్ మద్దతు మరియు మరింత వైవిధ్యమైన డెస్క్‌టాప్ షెల్స్ అవసరమయ్యే వినియోగదారుల కోసం దానిని మరింత ముందుకు తీసుకువెళుతుంది.

## 🏗️ ఇన్‌స్టాలేషన్: ఆటోమేటిక్ vs మాన్యువల్

MayankOS ప్రారంభించడానికి రెండు ప్రాథమిక మార్గాలను అందిస్తుంది:
...
- **ఇది ఎందుకు పరిపూర్ణమైనది**: ఇది సమగ్ర సాధనాల సూట్‌తో ముందే కాన్ఫిగర్ చేయబడింది:
  - **HDL సిమ్యులేషన్**: `iverilog`, `verilator`, `gtkwave`.
  - **సింథసిస్ & ఫిజికల్ డిజైన్**: `yosys`, `magic-vlsi`, `klayout`, `openroad`.
  - **FPGA & ఎంబెడెడ్ డెవలప్‌మెంట్**: `nextpnr`, `icestorm`, `dfu-util`, `qemu`.
  - **PCB & స్కీమాటిక్ డిజైన్**: `kicad`, `ngspice`.
...
- **భవిష్యత్తు కోసం సిద్ధంగా ఉంది**: ఇది కేవలం ప్రారంభం మాత్రమే; హార్డ్‌వేర్ డిజైనర్ల కోసం MayankOSను అంతిమ ప్లాట్‌ఫారమ్‌గా మార్చడానికి భవిష్యత్తు అప్‌డేట్‌లలో మరిన్ని ప్రత్యేకమైన VLSI మరియు EDA సాధనాలు ప్లాన్ చేయబడ్డాయి.
