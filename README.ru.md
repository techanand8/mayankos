...
- **Готовность к будущему**: Это только начало; в будущих обновлениях запланировано добавление более специализированных инструментов VLSI и EDA (including built-in OpenLane v2 support), чтобы сделать MayankOS идеальной платформой для разработчиков оборудования.
