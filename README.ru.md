...
MayankOS является гордым потомком легендарного проекта [ZaneyOS](https://gitlab.com/Zaney/zaneyos.git). Хотя она разделяет тот же дух стремления сделать NixOS доступной и красивой, MayankOS превратилась в отдельный дистрибутив со своими особенностями:

### 🌟 Что делает MayankOS особенной?
- **Фокус на современном оборудовании**: В отличие от более общего подхода ZaneyOS, MayankOS включает глубокую оптимизацию для последней серии **AMD Ryzen 7000** и **ноутбуков MSI** (включая управление состоянием батареи).
...
MayankOS специально разработана как высокопроизводительная профессиональная рабочая станция для **VLSI и проектирования оборудования**.

- **Почему она идеальна**: она поставляется с предварительно настроенным набором инструментов для:
  - **HDL-моделирование**: `iverilog`, `verilator`, `gtkwave`.
  - **Синтез и физическое проектирование**: `yosys`, `magic-vlsi`, `klayout`, `openroad`.
  - **Разработка ПЛИС (FPGA) и встраиваемых систем**: `nextpnr`, `icestorm`, `dfu-util`, `qemu`.
  - **Проектирование печатных плат и схем**: `kicad`, `ngspice`.
...
- **Готовность к будущему**: Это только начало; в будущих обновлениях запланировано добавление более специализированных инструментов VLSI и EDA, чтобы сделать MayankOS идеальной платформой для разработчиков оборудования.
...
+
+Если вы предпочитаете другой браузер, MayankOS позволяет легко переключиться:
...
+
+Мы верим в выбор и свободу. MayankOS создана для того, чтобы быть вашей личной рабочей станцией — не стесняйтесь настраивать ее под себя!
+
