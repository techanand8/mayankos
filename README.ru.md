...
- **Интеграция Niri**: Мы добавили первоклассную поддержку для композитора **Niri scrollable-tiling**, уникального рабочего процесса, которого нет в оригинальной ZaneyOS.
