{host, ...}: let
  ...
  noctaliaBind =
    ...
    then [
      # The Super-key-only launcher (bindr = bind on release)
      # " , SUPER_L, Noctalia Launcher, exec, noctalia-shell ipc call launcher toggle"
  ...
  wayland.windowManager.hyprland.settings = {
    bindd =
      ...
      ++ [
        ...
        # ============= SCREENSHOTS =============
        ", Print, Screenshot Fullscreen, exec, hyprshot -m output -o $HOME/Pictures/Screenshots"
        "$modifier, Print, Screenshot Region, exec, hyprshot -m region -o $HOME/Pictures/Screenshots"
        "SHIFT, Print, Screenshot Window, exec, hyprshot -m window -o $HOME/Pictures/Screenshots"
