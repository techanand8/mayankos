...
MayankOS प्रसिद्ध [ZaneyOS](https://gitlab.com/Zaney/zaneyos.git) प्रोजेक्ट का एक गर्वित वंशज है। हालाँकि यह NixOS को सुलभ और सुंदर बनाने की एक ही भावना साझा करता है, लेकिन यह अपने स्वयं के फोकस के साथ एक विशिष्ट वितरण के रूप में विकसित हुआ है:
...
यहाँ शुरू करने के दो प्राथमिक तरीके दिए गए हैं:
...
यह सिस्टम विशेष रूप से **VLSI और हार्डवेयर इंजीनियरिंग** के लिए एक उच्च-प्रदर्शन, पेशेवर वर्कस्टेशन के रूप में डिज़ाइन किया गया है।
...
- इस प्रोजेक्ट का पूरा विचार NixOS को एक सुलभ स्थान बनाना है।
- NixOS वास्तव में एक महान समुदाय है जिसका आप हिस्सा बनना चाहेंगे।
- कई लोग जो धैर्यवान हैं और आपकी मदद करने के लिए अपना खाली समय बिताने में खुश हैं, वे इस कॉन्फ़िगरेशन का उपयोग कर रहे हैं।
...
यह कई वातावरणों का समर्थन करता है:
...
## ⚡ पेशेवर VLSI और हार्डवेयर क्षमताएं

यह एनवायरनमेंट हार्डवेयर इंजीनियरिंग के लिए एक पावरहाउस है। यहाँ आपको सिर्फ टूल्स ही नहीं, बल्कि एक पूरा वर्कफ़्लो मिलता है।

### 🚀 आप क्या कर सकते हैं
- **SoC और CPU डिज़ाइन:** शुरुआत से जटिल RISC-V या ARM-आधारित SoC डिज़ाइन करें।
- **उन्नत सत्यापन (DV):** अपने डिज़ाइन को बग-मुक्त बनाने के लिए **slang**, **morty**, और **cocotb** का उपयोग करें।
- **RTL-to-GDSII:** **LibreLane** और **OpenROAD** का उपयोग करके कोड से फिजिकल चिप लेआउट तक पहुँचें।
- **एनालॉग सिम्युलेशन:** **Ngspice** और **Xyce** के साथ सर्किट सिम्युलेशन करें और **Magic-VLSI** के साथ लेआउट डिज़ाइन करें।

### 🛠️ उन्नत EDA और nix-eda
हमने **nix-eda** और **LibreLane** जैसे उन्नत फ्लेक्स को पहले से ही सिस्टम में एकीकृत (integrate) कर दिया है। इसका मतलब है कि आपके पास उन टूल्स तक पहुँच है जिन्हें साधारण लिनक्स पर इंस्टॉल करना मुश्किल होता है।

### ⌨️ कीबाइंडिंग और डेस्कटॉप प्रबंधन
शॉर्टकट के लिए **Mod (Super/Windows key)** का उपयोग करें:
- **Mod + Return:** टर्मिनल खोलें
- **Mod + D / Space:** ऐप लॉन्चर
- **Mod + Q:** विंडो बंद करें
- **Mod + E / T:** फ़ाइल मैनेजर
- **Mod + Alt + K:** सभी कीबाइंडिंग देखें

#### **एनवायरनमेंट कैसे बदलें**
- **KDE Plasma:** `modules/core/xserver.nix` में `plasma6.enable = false;` सेट करें।
- **Hyprland:** `modules/core/packages.nix` में `hyprland.enable = false;` सेट करें।
- **Niri:** `variables.nix` में `niriEnable = false;` सेट करें।

### 📘 विनम्र स्थापना और सीखना
*हम किसी भी पिछली गलती के लिए तहे दिल से माफी मांगते हैं। हमारा उद्देश्य केवल आपकी सहायता करना है।*
1. **इंस्टॉल करें:** `git clone https://github.com/techanand8/mayankos.git ~/mayankos` फिर `./install-mayankos.sh` चलाएं।

⚠️ एक महत्वपूर्ण बात याद रखें:
जब आप पहली बार एक ताज़ा NixOS इंस्टॉलेशन पर स्क्रिप्ट चलाते हैं, तो आपको यह सुनिश्चित करना होगा कि git और pciutils उपलब्ध हों। यदि वे नहीं हैं, तो स्क्रिप्ट आपको बताएगी, लेकिन आप उन्हें चलाकर जल्दी से प्राप्त कर सकते हैं:
...
निर्णय: स्क्रिप्ट ठोस है। यह आपके रिपॉजिटरी की सटीक संरचना से मेल खाती है और "कठिन भागों" (जैसे flake.nix और variables.nix को अपडेट करना) को स्वचालित रूप से संभालती है। आप सुरक्षित हैं! 🚀

2. **रीबिल्ड:** किसी भी समय जब आप कोई सेटिंग बदलते हैं, तो `mcli rebuild` चलाएं।