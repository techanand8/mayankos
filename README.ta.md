...
n**குறிப்பு: இந்த மொழிபெயர்ப்பில் ஏதேனும் மொழிப் பிழைகள் இருந்தால் தயவுசெய்து மன்னிக்கவும்; ஆவணங்கள் மற்றும் திட்டத்தை நீங்கள் நன்றாகப் புரிந்துகொள்வதற்காக இதை உங்கள் மொழியில் வழங்கியுள்ளேன். தொழில்நுட்பத் துல்லியத்திற்கு, தயவுசெய்து ஆங்கிலம் அல்லது ஸ்பானிஷ் பதிப்புகளைப் பார்க்கவும்.**
...
MayankOS புகழ்பெற்ற [ZaneyOS](https://gitlab.com/Zaney/zaneyos.git) திட்டத்தின் பெருமைமிக்க வாரிசு ஆகும். NixOS ஐ அணுகக்கூடியதாகவும் அழகாகவும் மாற்றும் அதே உணர்வைப் பகிர்ந்து கொண்டாலும், இது அதன் சொந்த கவனத்துடன் ஒரு தனித்துவமான விநியோகமாக உருவெடுத்துள்ளது:
...
- **விரிவாக்கப்பட்ட கம்போஸிட்டர் விருப்பங்கள்**: **Niri ஸ்க்ரோலபிள்-டைலிங் கம்போஸிட்டருக்கான** முழு ஆதரவை நாங்கள் ஒருங்கிணைத்துள்ளோம், ஸ்க்ரோலபிள் டைலிங் பணிப்பாய்வுகளை விரும்பும் பயனர்களுக்கு Hyprland-ற்கு நவீன மாற்றாக இது அமைகிறது.
...
## 🏗️ நிறுவல்: தானியங்கி vs கையேடு

MayankOS தொடங்க இரண்டு முதன்மையான வழிகளை வழங்குகிறது:
1. **தானியங்கி ஸ்கிரிப்ப்ட் (புதிய பயனர்களுக்கு பரிந்துரைக்கப்படுகிறது)**: உங்களுக்காக அனைத்தையும் கையாளும் வேகமான, ஒரு-கட்டளை நிறுவல். வேலை செய்யும் டெஸ்க்டாப்பைப் பெறுவதற்கான விரைவான வழி இதுவாகும்.
2. **கையேடு நிறுவல்**: தங்கள் கணினியின் ஒவ்வொரு அம்சத்திலும் முழுமையான கட்டுப்பாட்டை விரும்பும் பயனர்களுக்கு. உங்கள் முதல் மறுசீரமைப்பிற்கு *முன்பு* உங்கள் கருவிகளைத் தனிப்பயனாக்க விரும்பினால் கையேடு நிறுவல் சிறந்தது.

## ⚡ தொழில்முறை VLSI மற்றும் வன்பொருள் பொறியியல் பணிநிலையம்

MayankOS குறிப்பாக **VLSI மற்றும் வன்பொருள் பொறியியலுக்கு** உயர் செயல்திறன் கொண்ட, தொழில்முறை பணிநிலையமாக வடிவமைக்கப்பட்டுள்ளது.

- **இது ஏன் சரியானது**: இது பின்வருவனவற்றிற்கான விரிவான கருவிகளுடன் முன்பே கட்டமைக்கப்பட்டுள்ளது:
  - **HDL உருவகப்படுத்துதல்**: `ghdl`, `nvc`, `iverilog`, `verilator`, `gtkwave`, `surfer`, `fusesoc`, `surelog`.
  - **தொகுப்பு மற்றும் உடல் வடிவமைப்பு**: `yosys`, `magic-vlsi`, `netgen`, `klayout`, `openroad`, `xschem`, `gdsfactory`. (OpenLane ready)
  - **FPGA மற்றும் உட்பொதிக்கப்பட்ட மேம்பாடு**: `nextpnr`, `icestorm`, `openfpgaloader`, `dfu-util`, `qemu`.
  - **LSPs & கருவிகள்**: `sv-lang`, `vhdl-ls`, `verible`, `veridian`, `svls`, `pyverilog`, `verilogae`, `volare`.
  - **PDKs**: `volare` மூலம் **SkyWater 130** மற்றும் **GF180MCU** க்கான முழு ஆதரவு.
  - **PCB மற்றும் திட்ட வடிவமைப்பு**: `kicad`, `ngspice`, `doxygen`.
...
- **தனிப்பயனாக்குவது எப்படி**: உங்களுக்கு இந்தக் கருவிகள் தேவையில்லை என்றால், உங்கள் `nixos-rebuild` ஐ இயக்கும் முன் `modules/core/packages.nix` இல் உள்ள `# --- VLSI & Hardware Engineering ---` தொகுதியை நீங்கள் கமெண்ட் செய்யலாம் அல்லது நீக்கலாம்.
- **மேம்பட்ட EDA (Advanced EDA)**: **OpenLane** அல்லது தரமான Nixpkgs-இல் இன்னும் இல்லாத மேம்பட்ட DFT தொகுப்புகளுக்கு, PDK இணக்கத்தன்மையை உறுதிப்படுத்த [nix-eda](https://github.com/nix-eda/nix-eda) ஓவர்லே அல்லது Docker கன்டெய்னர்களைப் பயன்படுத்த பரிந்துரைக்கிறோம்.
- **எதிர்காலத்திற்கு தயார்**: இது ஆரம்பம் மட்டுமே; வன்பொருள் வடிவமைப்பாளர்களுக்கு MayankOS ஐ இறுதித் தளமாக மாற்ற எதிர்கால புதுப்பிப்புகளில் (உள்ளமைக்கப்பட்ட OpenLane v2 ஆதரவு உட்பட) மேலும் சிறப்பு வாய்ந்த VLSI மற்றும் EDA கருவிகள் திட்டமிடப்பட்டுள்ளன.

## 🌐 இணைய உலாவி தேர்வு மற்றும் தனிப்பயனாக்கம்

### ஏன் மைக்ரோசாப்ட் எட்ஜ்?

முன்னிருப்பாக, MayankOS இப்போது **Microsoft Edge** ஐப் பயன்படுத்துகிறது. லினக்ஸ் சமூகம் பயர்பாக்ஸ், ஜென் அல்லது பிரேவ் போன்ற உலாவிகளுக்கு வலுவான முன்னுரிமைகளைக் கொண்டுள்ளது என்பதை நாங்கள் அங்கீகரிக்கிறோம். இருப்பினும், இந்த பணிநிலையத்திற்காக எட்ஜ் தேர்ந்தெடுக்கப்பட்டது ஏனெனில்:
- **இணக்கத்தன்மை**: இது தொழில்முறை வன்பொருள் ஆவண போர்ட்டல்கள் மற்றும் இணைய அடிப்படையிலான EDA கருவிகளுடன் சிறந்த நிலைத்தன்மையை வழங்குகிறது.
- **செயல்திறன்**: இது கனமான தொழில்நுட்ப ஆராய்ச்சிக்கு திறமையான PDF கையாளுதல் மற்றும் நினைவக மேலாண்மையை வழங்குகிறது.
- **பணிப்பாய்வு**: இது இந்த VLSI பணிநிலையத்தின் குறிப்பிட்ட பொறியியல் தேவைகளுடன் ஒத்துப்போகிறது.

### உங்கள் முன்னிருப்பு உலாவியை எவ்வாறு மாற்றுவது

நீங்கள் வேறு உலாவியை விரும்பினால், MayankOS அதை மாற்றுவதை எளிதாக்குகிறது:
1. **மாறியை மாற்றவும்**: உங்கள் ஹோஸ்டின் `variables.nix` கோப்பைத் திறந்து (எ.கா., `hosts/msi-modern14c7m/variables.nix`) `browser` வரியை உங்கள் விருப்பத்திற்கு மாற்றவும் (எ.கா., `browser = "firefox";`).
2. **நிறுவலைச் சரிபார்க்கவும்**: உங்களுக்கு விருப்பமான உலாவி `modules/core/packages.nix` இல் பட்டியலிடப்பட்டுள்ளதா என்பதை உறுதிப்படுத்தவும். அது அங்கு இல்லை என்றால், அதன் தொகுப்பு பெயரை (எ.கா., `librewolf`) பட்டியலில் சேர்க்கவும்.
3. **மீண்டும் உருவாக்கு (Rebuild)**: மாற்றத்தைப் பயன்படுத்த `mcli rebuild` அல்லது உங்கள் குறிப்பிட்ட ரீபில்ட் கட்டளையை (எ.கா., `sudo nixos-rebuild switch --flake .#amd`) இயக்கவும்.

நாங்கள் தேர்வு மற்றும் சுதந்திரத்தை நம்புகிறோம். இந்த சூழல் உங்கள் தனிப்பட்ட பணிநிலையமாக வடிவமைக்கப்பட்டுள்ளது—அதை உங்களுடையதாக மாற்ற தயங்காதீர்கள்!
...
- VLSI மற்றும் வன்பொருள் பொறியியல் வழிகாட்டி: [English](cheatsheets/vlsi-guide.md) | [Español](cheatsheets/vlsi-guide.es.md)
